...
const DEEP_SEARCH_ITEMS: DeepItem[] = [
  ...
  ...([
    ...
    'Rune Mysteries', 'Dragon Slayer I', 'Vampire Slayer', 'Demon Slayer',
    ...
    'Gnome Restaurant', 'Fremennik Trials', 'Fremennik Isles', 'Fremennik Exiles',
    'Cabin Fever', 'Rum Deal', 'Slug Menace', 'Swan Song',
    ...
    'Lost City', 'Fairy Tale Part I', 'Fairy Tale Part II', 'Fairy Tale Part III',
